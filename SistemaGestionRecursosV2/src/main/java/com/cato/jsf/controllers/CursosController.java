...
import com.cato.sessions.CursosFacade;
...
public class CursosController implements Serializable {
    ...
    @EJB
    private com.cato.sessions.CursosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("CursosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("CursosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("CursosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class CursosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cursos) {
                ...
                return getStringKey(o.getCursoId());
            } else {
