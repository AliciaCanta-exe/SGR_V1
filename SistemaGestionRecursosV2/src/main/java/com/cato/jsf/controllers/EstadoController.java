...
import com.cato.sessions.EstadoFacade;
...
public class EstadoController implements Serializable {
    ...
    @EJB
    private com.cato.sessions.EstadoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("EstadoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("EstadoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("EstadoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
