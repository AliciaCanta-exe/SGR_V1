...
angular.module('modContenidoDidactico_rmpp').factory('MallasService', ['$http', '$q', function($http, $q){

    var REST_SERVICE_URI = 'http://localhost:8082/SistemaGestionDeRecursosV1/listCursos/';
